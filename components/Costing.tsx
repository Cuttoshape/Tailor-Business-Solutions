      ...
      <div className="pt-1 pb-20 px-4">
                ...
                .map((item) => (
                  <div key={item.id} className="border border-gray-200 rounded-lg p-3">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <button onClick={() => removeItem(item.id)} className="w-6 h-6 flex items-center justify-center">
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm mb-4">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm text-gray-600 mb-2">Workmanship</label>
              <input
                type="number"
                placeholder="0.00"
                value={workmanship}
                  ...
                  <div className="flex space-x-1">
                    <button
                      ...
                      className={`px-3 py-2 rounded text-xs ${
                        vatRate === 0 ? "bg-indigo-600 text-white" : "bg-gray-100 text-gray-600"
                      }`}
                    >
                      0%
                    </button>
                    <button
                      ...
                      className={`px-3 py-2 rounded text-xs ${
                        vatRate === 7.5 ? "bg-indigo-600 text-white" : "bg-gray-100 text-gray-600"
                      }`}
                    >
                      7.5%
                    </button>
                    <button
                      ...
                      className={`px-3 py-2 rounded text-xs ${
                        vatRate === 15 ? "bg-indigo-600 text-white" : "bg-gray-100 text-gray-600"
                      }`}
                    >
                      15%
                    </button>
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm mb-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium">{currency === "USD" ? "$" : "₦"}{convertCurrency(workmanship)}</span>
            </div>
            <div className="flex justify-between text-sm">
            ...
            <div className="border-t pt-2">
              <div className="flex justify-between">
                ...
                <span className="font-bold text-indigo-600 text-lg">{currency === "USD" ? "$" : "₦"}{convertCurrency(totalWithVAT)}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <button onClick={onClose} className="w-full bg-indigo-600 text-white py-1 rounded-lg font-medium">Close</button>
          <button onClick={handleSave} className="w-full bg-gray-800 text-white py-1 rounded-lg font-medium">Save</button>
        </div>
      </div>
    </div>
  );
